...
public class RHEAPlayer1 extends AbstractPlayer implements IAnyTimePlayer {
    ...
    public RHEAPlayer1(RHEAParams params) {
        super(params, "RHEAPlayer");
    }

    public RHEAPlayer1(RHEAParams params, String name) {
        super(params, name);
    }
